...
const ar = {
  ...
  dateChoice: { today: "اليوم", tomorrow: "غدًا", other: "تاريخ آخر" },
  statDate: "مواعيد اليوم المحدد",
  newTitle: "موعد جديد",
...
const en: ClinicText = {
  ...
  dateChoice: { today: "Today", tomorrow: "Tomorrow", other: "Other date" },
  statDate: "Appointments on this date",
