...
/**
 * بيانات أولية مستخرجة من ملف «حركة السيارات اليومية» (11-07-2026 إلى 23-08-2026):
 * ملخص إحصائي فقط (بلا أسماء أو أرقام مرضى)، وقائمة السيارات والسائقين من ورقة «قائمة».
 * تُحفظ في قاعدة البيانات عند أول دخول للمدير إن لم تكن موجودة.
 */
